...
以root用户执行命令：<br/>
</p><pre><code>wget -N --no-check-certificate "https://raw.githubusercontent.com/aippnne/embyonekey/master/embyonekey.sh" && chmod +x embyonekey.sh && ./embyonekey.sh</code></pre>
...
Windows请安装此目录下
<br/>![](https://github.com/hangaj/embyonekey/blob/master/window.png)
